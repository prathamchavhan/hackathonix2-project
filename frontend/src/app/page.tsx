...
export default function Home() {
  return (
    <main
      className="min-h-screen bg-[url('/3.webp')] bg-cover bg-center text-slate-900 relative overflow-hidden flex flex-col items-center justify-center p-4 sm:p-8 md:p-24 selection:bg-primary/30"
    >
